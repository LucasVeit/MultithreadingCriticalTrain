...
void Serial(List<List<Item>>* train, List<Item>* illegals, unsigned long long int* totalValue){
    Node<List<Item>>* wagon = train->getFirst();
    Item item;
    while(wagon != nullptr){
...
void IndividualThread(Node<List<Item>>* wagon, List<Item>* illegals, unsigned long long int* totalValue){
...
void Parallel(List<List<Item>>* train, List<Item>* illegals, unsigned long long int* totalValue){
